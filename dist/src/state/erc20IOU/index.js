...
exports.useERC20IOU = exports.ERC20IOU = void 0;
const react_1 = require("react");
const zustand_1 = require("zustand");
const state_1 = __importDefault(require("./state"));
const ERC20IOU_1 = require("../../contracts/ERC20IOU");
/**
...
class ERC20IOU {
    ...
    constructor(contractAddress, signer) {
        ...
        this.contract = new ERC20IOU_1.ERC20IOUContract(contractAddress, signer);
    ...
    async getHash(from, amount, validUntil, validAfter, sequence) {
        try {
            ...
            const hash = await this.contract.getHash(from, amount, validUntil, validAfter, sequence);
    ...
    async redeem(from, amount, validUntil, validAfter, sequence, signature) {
        try {
            this.store.getState().request();
            await this.contract.redeem(from, amount, validUntil, validAfter, sequence, signature);
 ...
 */
const useERC20IOU = (contractAddress, provider) => {
    const erc20IOURef = (0, react_1.useRef)(new ERC20IOU(contractAddress, provider));
